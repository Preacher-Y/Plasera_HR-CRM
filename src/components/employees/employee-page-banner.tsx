...
export function EmployeePageBanner() {
  return (
    <div className="relative pt-6 lg:pt-8">
      ...
      <div className="relative rounded-2xl bg-login-panel overflow-hidden px-8 py-7 lg:py-12 min-h-33">
        <div className="relative z-10 max-w-[55%]">
          <h1 className="text-2xl lg:text-4xl font-bold text-white font-asul">Employee</h1>
      ...
      {/* Illustration */}
      <div className="absolute top-0 right-0 lg:-top-5 lg:right-4 bottom-0 w-65 sm:w-75 lg:w-96 pointer-events-none select-none">
        <Image
          src="/employeeIllustration.svg"
          alt=""
          fill
